  ...
  Future<void> _handleLogin() async {
    ...
    if (username.isEmpty || password.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Username & Password perlu diisi'),
        ),
      );
      return;
    }
    ...
    try {
      LoginResponse response = await _authService.login(username, password);
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Login gagal: $_errorMessage')),
      );
